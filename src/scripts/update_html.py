...
def main():
    ...
    with open('src/scripts/kafka_consumer_producer.bal', 'r') as action_obj:
        action_bbe = action_obj.readlines()

    old_text = soup.find('div', {'id':'kafka-consumer'})
    ...
    try:
        update = commit_file('index.html', updated_file, 'update-kafka-consumer-producer', commit_message)[0]
